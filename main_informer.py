...
from utils.loggers import WandbLogger, NoLogger
...
experiment_name = f'{args.des}-{datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}'
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(
        ...
        args.e_layers, args.d_layers, args.d_ff, args.attn, args.factor, args.embed, args.distil, args.mix, args.des,
        ii)

    if args.wandb_logging:
        logger = WandbLogger(
            name=f"{experiment_name}-{ii}",
